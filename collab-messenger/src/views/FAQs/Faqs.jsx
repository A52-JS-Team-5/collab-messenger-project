...
return (
    <div>
        ...
        <div className='flex flex-col gap-6 px-80 max-xl:px-10 pt-8 pb-8 bg-white text-white dark:bg-darkFront'>
                <div className="collapse collapse-arrow bg-black dark:bg-darkAccent">
                    <input type="checkbox" />
