...
function Home() {
  ...
  return (
    <div>
      <div className="hero my-12 bg-grey">
        <div className="hero-content flex-col lg:flex-row-reverse gap-14">
            ...
            <div className='flex flex-col items-start max-lg:items-center max-w-2xl'>
                <h1 className="text-5xl font-bold text-black text-left max-lg:text-center">Get to know Chatter</h1>
                <p className="py-6 text-black text-left max-lg:text-center">Where collaboration feels effortless, offering intuitive communication and customizable channels. Stay connected, work together, and unleash your team&apos;s creativity with Chatter - your go-to platform for smooth collaboration!</p>
                <div className='space-x-4'>
                    <button className="bg-pink text-black" onClick={() => navigate('/register')}>Register</button>
                    <button className="bg-darker-blue text-white" onClick={() => navigate('/login')}>Login</button>
                </div>
            </div>
        </div>
      </div>
      <div className="hero my-12 bg-white">
        <div className="hero-content flex-col lg:flex-row-reverse gap-14">
          <div className='flex flex-col items-start max-lg:items-center max-w-2xl'>
            <h2 className="text-5xl font-bold text-black text-left max-lg:text-center">Long heading is what you see here in this feature section</h2>
            <p className="py-6 text-black text-left max-lg:text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam libero vitae erat.</p>
          </div>
          <img src={image} className="max-w-md rounded-lg" />
        </div>
      </div>
      <div className="hero my-12 bg-grey">
        <div className="hero-content flex-col lg:flex-row-reverse gap-14">
          ...
          {/* carousel ends here */}
          <div className='flex flex-col items-start max-lg:items-center max-w-2xl'>
            <h2 className="text-5xl font-bold text-black text-left max-lg:text-center">Long heading is what you see here - Vertical Carousel</h2>
            <p className="py-6 text-black text-left max-lg:text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam libero vitae erat.</p>
          </div>
        </div>
      </div>
