  ...
  return (
    ...
    <div className="user-profile-wrapper">
      <div id='user-profile-modal' className={`${modalClass}`}>
        <div className="modal-box bg-gradient-to-b from-pureWhite from-20% to-lightBlue to-20% min-[320px]:max-w-2xl max-[4800px]:max-w-2xl">
          <button className="btn btn-sm btn-circle hover:bg-lightBlue border-none text-blue bg-pureWhite absolute right-2 top-2" onClick={onClose}>✕</button>
          <div className='flex flex-col gap-10'>
            <div className='flex flex-col'>
              <div className='flex flex-col gap-6'>
                <div className="avatar">
                  {userDetails?.status && <div className={`absolute left-[70px] bottom-0 w-4 h-4 rounded-full ${statusColors[userDetails?.status]} border-2 border-white z-40`}></div>}
                ...
                <div className='flex flex-col w-full rounded-md bg-pureWhite p-6'>
