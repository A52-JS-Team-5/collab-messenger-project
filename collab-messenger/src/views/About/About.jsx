...
//   }
  ...
  return (
    <>
      <div className="hero my-12 py-10">
        <div className="hero-content flex-col lg:flex-row-reverse gap-14">
            <div className='flex flex-col items-start max-lg:items-center max-w-2xl'>
                <h1 className="text-5xl font-bold text-black text-center max-lg:text-center dark:text-darkText">Describe why your company exists [mission statement]</h1>
                <p className="py-6 text-black text-center max-lg:text-center dark:text-darkText">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam libero vitae erat.</p>
            </div>
        </div>
      </div>
      <div className="hero my-12 py-10  gap-14 bg-grey dark:bg-darkFront">
        <div className="hero-content flex-col lg:flex-row-reverse">
            <img src={image} className="max-w-md rounded-lg" />
            <div className='flex flex-col items-start max-lg:items-center max-w-2xl'>
              <h1 className="text-5xl font-bold text-black text-left max-lg:text-center dark:text-darkText">About [company name]</h1>
        ...
        <div className="hero my-8 pt-10">
          <div className="hero-content flex-col lg:flex-row-reverse gap-14">
            <div className='flex flex-col items-start max-lg:items-center max-w-2xl'>
              <h1 className="text-5xl font-bold text-black text-center max-lg:text-center dark:text-darkText">Emphasize what&apos;s important to your company</h1>
              <p className="py-6 text-black text-center max-lg:text-center dark:text-darkText">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare.</p>
            </div>
          </div>
        </div>
        <div className='grid grid-cols-1 gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
            <div className='card text-black  dark:text-darkText'>
        ...
        <div className='p-10'>
                <p className='text-4xl font-bold text-black pb-10 dark:text-darkText'>Get to know the creators</p>
                <div className='flex gap-6 justify-center max-md:flex-col'>
                    <div className="card max-w-xs bg-white dark:bg-darkAccent">
                        <figure className="px">
                            <img src={image} alt="Silvia Stoykova" className="rounded-xl" />
                        </figure>
                        <div className="items-start text-center pt-5">
                            <h2 className="card-title text-black pt-2 dark:text-darkText">Silvia Stoykova</h2>
                            <p className="card-title text-black font-normal pt-2 dark:text-darkText">Job Title</p>
                            <p className="card-title text-black font-normal text-start pt-2 dark:text-darkText">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.</p>
                        </div>
                    ...
                    <div className="card max-w-xs bg-white dark:bg-darkAccent">
                        ...
                        <div className="items-start text-center pt-5">
                            <h2 className="card-title text-black pt-2 dark:text-darkText">Georgi Dobrev</h2>
                            <p className="card-title text-black font-normal pt-2 dark:text-darkText">Job Title</p>
                            <p className="card-title text-black font-normal text-start pt-2 dark:text-darkText">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.</p>
                        </div>
                        <div className='flex space-x-4 other-logos w-4 pt-4'>
                    ...
                    <div className="card max-w-xs bg-white dark:bg-darkAccent">
                        ...
                        <div className="items-start text-center pt-5">
                            <h2 className="card-title text-black pt-2 dark:text-darkText">Teodora Gigova</h2>
                            <p className="card-title text-black font-normal pt-2 dark:text-darkText">Job Title</p>
                            <p className="card-title text-black font-normal text-start pt-2 dark:text-darkText">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.</p>
                        </div>
                        <div className='flex space-x-4 other-logos w-4 pt-4'>
