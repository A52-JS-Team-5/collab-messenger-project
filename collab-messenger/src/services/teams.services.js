...
export const getTeamByName = (name) => {
  return get(query(ref(db, 'teams'), orderByChild('name'), equalTo(name)))
    .catch((e) => console.log('Error in getting team data by name: ', e.message));
};
...
export const getTeamById = (id) => {
  return get(ref(db, `teams/${id}`))
    ...
    .catch(e => console.log('Error in getting team data by ID', e.message))
};
...
export const editTeam = (teamName, updates) => {
  return update(ref(db, `teams/${teamName}`), updates)
    ...
    .catch(e => console.log('Error in editing team: ', e.message))
};
...
export const getAllTeamsCount = () => {
  return get(ref(db, `teams`))
    ...
    .catch(e => console.log(`Error in getting teams' count: `, e.message));
};
...
export const addTeam = (handle, teamId) => {
  ...
  return update(ref(db), updateTeam)
    .catch((e) => console.log('Error in adding team: ', e.message));
};
...
export const updateTeamMembers = (teamId, members) => {
  ...
  return update(ref(db), updateTeam)
    .catch((e) => console.log('Error in changing team members: ', e.message));
};
...
export const removeTeamMember = (teamId, member) => {
  ...
  return update(ref(db), updates)
    .catch((e) => console.log('Error in removing team member: ', e.message));
};
...
export const removeTeamFromUser = (teamId, member) => {
  ...
  return update(ref(db), updates)
    .catch((e) => console.log('Error in removing team from user: ', e.message));
};
...
export const removeTeamFromOwner = (teamId, member) => {
  ...
  return update(ref(db), updates)
    .catch((e) => console.log('Error in removing team from owner', e.message));
};
...
export const getTeamsByUser = (handle) => {
  return get(ref(db, `users/${handle}/teamsMember`))
    .then((snapshot) => {
      ...
      .catch((e) => console.log('Error in getting teams of user: ', e.message));
};
